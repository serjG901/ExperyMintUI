export async function getMessages(otherUserID) {
  let response = await fetch("https://287yb.sse.codesandbox.io/getmessages/", {
    method: "POST",
    headers: {
...
export async function deleteMessage(messageID) {
  let response = await fetch(
    "https://287yb.sse.codesandbox.io/deletemessage/",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=utf-8"
...
export async function sendMessage(otherUserID, message, currentDate) {
  let response = await fetch("https://287yb.sse.codesandbox.io/sendmessage/", {
    method: "POST",
    headers: {
      "Content-Type": "application/json;charset=utf-8"
    },
...
export async function setIsRead(messageID) {
  let response = await fetch("https://287yb.sse.codesandbox.io/setisread/", {
    method: "POST",
    headers: {
      "Content-Type": "application/json;charset=utf-8"
    },
